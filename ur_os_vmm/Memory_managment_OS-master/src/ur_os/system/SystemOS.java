...
public class SystemOS implements Runnable{
    ...
    public void initSimulationQueueSimplerV3() {
    ...
    p.setSize(tempSize);
    p.addCPUInstructions(4);
    temp = new MemoryInstruction(MemoryOperationType.STORE, r.nextInt(tempSize), (byte)45, 2);
    p.addInstruction(temp);
    p.addCPUInstructions(2);
    temp = new EndInstruction();
    p.addInstruction(temp);
    ...
    p.setSize(tempSize);
    p.addCPUInstructions(2);
    temp = new MemoryInstruction(MemoryOperationType.STORE, r.nextInt(tempSize), (byte)30, 5);
    p.addInstruction(temp);
    p.addCPUInstructions(4);
    temp = new EndInstruction();
    p.addInstruction(temp);
